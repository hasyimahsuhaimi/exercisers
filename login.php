...
<body>
    ...
    <div class="container py-lg-5 py-md-4">
		<h3 class="section-title-left">Login </h3>
		<div class="contact-grids d-grid">
			...
			<div>
				...
				{							
					...
					if ( $id== null)
					{
						echo "<p><label style='color:red'>WRONG USER NAME OR PASSWORD!</label></p>";
					}
					else
					{		
						session_start();
				...
				<div class="input-grids">  
					<button class="btn btn-style btn-outline" name="submit" value="submit" >Login</button>
				 </div>
				</form>
